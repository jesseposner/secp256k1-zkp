...
void test_ecdsa_adaptor_spec_vectors_check(const unsigned char *adaptor_sig162, const unsigned char *msg32, const unsigned char *pubkey33, const unsigned char *encryption_key33, const unsigned char *decryption_key32, const unsigned char *signature64, int verify_expected, int decrypt_expected) {
    ...
    CHECK(verify_expected == secp256k1_ecdsa_adaptor_sig_verify(ctx, adaptor_sig162, &pubkey, msg32, &encryption_key));
    ...
    CHECK(decrypt_expected == secp256k1_memcmp_var(signature, signature64, 64));

    /* ecdsa_adaptor_recover */
    secp256k1_ecdsa_adaptor_extract_secret(ctx, adaptor_secret, &s, adaptor_sig162, &encryption_key);
    CHECK(0 == secp256k1_memcmp_var(adaptor_secret, decryption_key32, 32));
}
...
void test_ecdsa_adaptor_spec_vectors(void) {
    {
        ...
        test_ecdsa_adaptor_spec_vectors_check(adaptor_sig, msg, pubkey, encryption_key, decryption_key, signature, 1, 0);
    }
    {
        /* Test vector 1 */
        const unsigned char adaptor_sig[162] = {
            
        };
        const unsigned char msg[32] = {
            0x81, 0x31, 0xe6, 0xf4, 0xb4, 0x57, 0x54, 0xf2,
        ...
        const unsigned char pubkey[33] = {
            0x03, 0x19, 0xf3, 0xa6, 0x8a, 0x80, 0x70, 0xe4,
            0x0a, 0xd3, 0xd6, 0x68, 0x88, 0x92, 0x10, 0xb9,
            0x33, 0xf9, 0x36, 0xf4, 0x0e, 0x61, 0xb8, 0x5e,
            0x25, 0x82, 0x29, 0x84, 0x07, 0xa5, 0x95, 0x6d,
            0xe9
        };
        const unsigned char encryption_key[33] = {
            0x02, 0xb1, 0x8f, 0x46, 0x4f, 0x3c, 0x91, 0x62,
            0xcd, 0x8c, 0xdd, 0x4e, 0xb1, 0x86, 0x4d, 0x60,
            0x58, 0x12, 0xc9, 0x54, 0x62, 0xd4, 0x0c, 0x5e,
            0x92, 0xe7, 0xe1, 0xc4, 0x12, 0xe5, 0x09, 0x7b,
            0xdf
        };
        const unsigned char decryption_key[32] = {
            0x7b, 0xfc, 0xfd, 0x75, 0x44, 0xb1, 0x07, 0x8d,
            0xda, 0x39, 0x7c, 0xef, 0x45, 0xdf, 0x2e, 0x6d,
            0xe4, 0x98, 0x74, 0x68, 0x05, 0x08, 0x1e, 0xbc,
            0x8f, 0xb9, 0x0a, 0xd0, 0x4e, 0xba, 0x9d, 0x02
        };
        const unsigned char signature[64] = {
            0x2b, 0xfc, 0xc9, 0xaf, 0x9a, 0x7e, 0xed, 0x20,
            0xc4, 0xdf, 0xba, 0x1c, 0xc1, 0x23, 0xab, 0xa4,
            0x1d, 0x32, 0x28, 0x10, 0xbf, 0xdf, 0x6c, 0x94,
            0x7e, 0x21, 0x65, 0x97, 0x8c, 0x91, 0xab, 0x55,
            0x67, 0x9e, 0xa6, 0x1a, 0x6d, 0x47, 0x8c, 0x3b,
            0x59, 0x7d, 0x4c, 0xff, 0x7f, 0x84, 0x3f, 0x2f,
    ...
    }
    {
        /* Test vector 2 */
        const unsigned char adaptor_sig[162] = {
            
        };
        const unsigned char msg[32] = {
            0x81, 0x31, 0xe6, 0xf4, 0xb4, 0x57, 0x54, 0xf2,
        ...
        const unsigned char pubkey[33] = {
            0x03, 0xef, 0x16, 0xdd, 0x7c, 0x75, 0xca, 0x40,
            0xcf, 0xea, 0xb2, 0xaa, 0x65, 0x9f, 0x22, 0x01,
            0xe8, 0x57, 0x59, 0x1d, 0xf3, 0xde, 0x67, 0x49,
            0x4a, 0x4d, 0x1d, 0xae, 0x34, 0x58, 0x73, 0x95,
            0xe6
        };
        const unsigned char encryption_key[33] = {
            0x02, 0x54, 0x42, 0x5b, 0x8f, 0x73, 0x75, 0x4f,
            0x16, 0xf7, 0x58, 0x93, 0x7f, 0xda, 0xb3, 0x9a,
            0x04, 0xea, 0x61, 0x76, 0x3f, 0x9c, 0x8b, 0x2b,
            0xa8, 0xab, 0xe0, 0x82, 0x88, 0x2d, 0xdb, 0xf1,
            0x55
        };
        const unsigned char decryption_key[32] = {
            0x7f, 0x82, 0xdd, 0x63, 0xf4, 0xf7, 0x5c, 0x33,
            0xda, 0x44, 0x4b, 0x72, 0x37, 0x2b, 0xe3, 0xaa,
            0x43, 0xc0, 0x02, 0x7a, 0x07, 0x6b, 0xf9, 0x67,
            0x5e, 0xb7, 0x93, 0x26, 0x95, 0xd1, 0x27, 0xa4
        };
        const unsigned char signature[64] = {
            0x42, 0x88, 0xa3, 0xe3, 0xd0, 0x8a, 0xc2, 0x9b,
            0xab, 0x9a, 0x63, 0x96, 0xa0, 0xc4, 0xc2, 0xa7,
            0x4a, 0x92, 0x3d, 0xba, 0xca, 0x92, 0xc4, 0x69,
            0xfe, 0x38, 0xeb, 0x0b, 0xfd, 0xe1, 0x31, 0xb2,
            0x13, 0x21, 0xd7, 0x5e, 0x2d, 0x15, 0x54, 0x37,
            0xf4, 0xf5, 0xb9, 0x18, 0xc9, 0xbe, 0xcb, 0x32,
    ...
    }
    {
        ...
        const unsigned char adaptor_sig[162] = {
            ...
            0xc1, 0x45, 0x4f, 0x2a, 0x12, 0x78, 0x5e, 0x3b,
            0xd3, 0x71, 0xb1, 0xa0, 0x70, 0xd3, 0x7c, 0x85,
            0x6b, 0x4a, 0xa5, 0x23, 0x61, 0xb1, 0x67, 0x74,
            0xb2, 0xcf, 0xb8, 0xf0, 0x36, 0xb4, 0x7c, 0x71,
            0x43, 0xde, 0x8b, 0x42, 0xe6, 0xe8, 0x48, 0xc8,
            0x43, 0x82, 0x68, 0x09, 0xcc, 0x17, 0x01, 0x53,
            0x00, 0x08, 0xd0, 0x5a, 0xd3, 0x15, 0x06, 0x8f,
            0x38, 0xbc, 0xe8, 0x7f, 0xfe, 0x26, 0x9f, 0xed,
            0x4c, 0xfb, 0x68, 0x43, 0x8a, 0x53, 0x6e, 0x64,
            0xbd, 0xa2, 0xd6, 0xba, 0xc6, 0x95, 0x03, 0x8b,
            0x24, 0x99, 0x34, 0x8a, 0x2a, 0x6f, 0xed, 0x03,
        ...
        test_ecdsa_adaptor_spec_vectors_check(adaptor_sig, msg, pubkey, encryption_key, decryption_key, signature, 0, 0);
    }
    {
        /* Test vector 4 */
        const unsigned char adaptor_sig[162] = {
        ...
        const unsigned char signature[64] = {
            0xbd, 0x77, 0x5c, 0x1c, 0x2f, 0x75, 0x3d, 0x64,
            0x54, 0x65, 0x9c, 0x69, 0x5f, 0x3b, 0x3d, 0x57,
            0x70, 0x1c, 0x9f, 0x2b, 0xe4, 0xb5, 0xdb, 0xd1,
            0xc1, 0x99, 0x73, 0x80, 0xd2, 0x55, 0x0f, 0x8f,
            0x13, 0x21, 0xd7, 0x5e, 0x2d, 0x15, 0x54, 0x37,
            0xf4, 0xf5, 0xb9, 0x18, 0xc9, 0xbe, 0xcb, 0x32,
            0x70, 0x96, 0xdd, 0x5e, 0x72, 0x34, 0x3f, 0x39,
            0xc5, 0x15, 0x65, 0xb6, 0x11, 0x0f, 0x78, 0xbe
        };
        test_ecdsa_adaptor_spec_vectors_check(adaptor_sig, msg, pubkey, encryption_key, decryption_key, signature, 1, -123);
    }
    {
        /* Test vector 5 */
        const unsigned char adaptor_sig[162] = {
            ...
            0xbc, 0x20, 0x2f, 0x6b, 0xf5, 0xfe, 0x66, 0x80,
            0x5c, 0xb9, 0x57, 0xc8, 0x92, 0x75, 0xce, 0xe3,
            0x41, 0x39, 0x0d, 0x5c, 0x3d, 0xbb, 0x63, 0x9f,
            0xe9, 0x62, 0xd2, 0xd6, 0x80, 0x5e, 0x49, 0xef,
            0x17, 0x83, 0xe8, 0x90, 0x50, 0xb5, 0xa0, 0x42,
            0xdc, 0x56, 0xe8, 0x38, 0x14, 0x0d, 0xde, 0xb8,
            0xef, 0x88, 0x15, 0x99, 0x37, 0x45, 0x78, 0x79,
            0xee, 0x01, 0xb4, 0x21, 0xb8, 0x6d, 0x21, 0x17,
            0xc4, 0xd2, 0xe5, 0x6f, 0xea, 0x1a, 0x38, 0xeb,
            0x9c, 0xbf, 0x77, 0x30, 0x1a, 0x2f, 0xd6, 0xa3,
            0x4c, 0x14
        };
        const unsigned char msg[32] = {
            0x81, 0x31, 0xe6, 0xf4, 0xb4, 0x57, 0x54, 0xf2,
